...
def createFastTextModel(data, isSG, vectorSize, maxNgram, modelFilePath):
    # train model
    model_gensim = FT_gensim(sg=isSG, size=vectorSize, min_count=1, min_n=1, max_n=maxNgram)
...
if __name__ == '__main__':
    ...
    timeInfoFolder = "PROJECT_PATH/FastText_Rec/model/model_janjuly/model_fasttext/"
