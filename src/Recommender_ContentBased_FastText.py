...
def rankRecommendations(item_2_scores):
    item_2_avg_score = {}
    for item, scores in item_2_scores.iteritems():
...
def recommend(recommendation_type, rec_output_size,
    ...
    for user_id, user_locations in user_2_locations.iteritems():
...
def run(recommendation_type, rec_output_size,
        trainDataFilePath, modelFolder, baseModelFileName, timeInfoFolder, timeInfoFile,
        recommendationOutputFolder, baseRecommendationOutputFileName):
...
if __name__ == '__main__':
    ...
    modelFolder = "PROJECT_PATH/FastText_Rec/model/model_janjuly/model_fasttext/"
    baseModelFileName = "fasttext_locs_only_model"
    timeInfoFolderBase = "PROJECT_PATH/FastText_Rec/output/output_janjuly/fasttext_contentfilter/"
    ...
    for recommendation_type in recommendation_types:
        ...
        run(recommendation_type, rec_output_size,
            trainDataFilePath,  modelFolder, baseModelFileName,
